...
module "jumphost" {
  source = "github.com/nubisproject/nubis-jumphost//nubis/terraform?ref=v1.4.1"
...
module "fluent-collector" {
  source = "github.com/nubisproject/nubis-fluent-collector//nubis/terraform/multi?ref=v1.4.1"
...
module "monitoring" {
  source = "github.com/nubisproject/nubis-prometheus//nubis/terraform?ref=v1.4.1"
...
module "ci" {
  source = "github.com/nubisproject/nubis-ci//nubis/terraform?ref=v1.4.1"
