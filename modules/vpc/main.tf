...
module "nat-image" {
  source        = "github.com/nubisproject/nubis-terraform//images?ref=v1.3.0"
  region        = "${var.aws_region}"
...
module "fluent-collector" {
  source = "github.com/nubisproject/nubis-fluent-collector//nubis/terraform?ref=v1.3.0"
...
module "sso" {
  source = "github.com/nubisproject/nubis-sso//nubis/terraform?ref=v1.3.0"
...
module "consul" {
  source = "github.com/nubisproject/nubis-consul//nubis/terraform?ref=v1.3.0"
...
module "vpn" {
  source = "github.com/nubisproject/nubis-terraform-vpn?ref=v1.3.0"
...
module "kubnernetes" {
  source = "github.com/nubisproject/nubis-kubernetes//nubis/terraform?ref=v1.3.0"
